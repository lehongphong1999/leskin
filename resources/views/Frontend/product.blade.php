...
<div class="list-brand">
    <div class="title">
        <a href="{{ route('index') }}" style="color: black;">Trang chủ</a> <a ><i class="fa fa-angle-right" aria-hidden="true"></i> Mỹ Phẩm </a>
    </div>
    ...
    <div style="width: 15%;margin: auto;">{{ $product->links() }}</div>
</div>
